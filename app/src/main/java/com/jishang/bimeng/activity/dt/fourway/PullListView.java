...
public class PullListView extends ListView implements OnScrollListener {
    ...
    public void onCompleteRefresh() {
        ...
        mCurrentSmoothScrollRunnable = new SmoothScrollRunnable(headerView.getPaddingTop() + mTop,
                0, 300, new OnSmoothScrollFinishedListener() {
                    @Override
    ...
    private void OnRefreshing() {
        ...
        mCurrentSmoothScrollRunnable = new SmoothScrollRunnable(headerView.getPaddingTop() + mTop,
                mTop, 300, new OnSmoothScrollFinishedListener() {
                    @Override
                    public void onSmoothScrollFinished() {
