...
import com.jishang.bimeng.activity.shangcheng.ActivityShangcheng.ViewHolder1;
...
public class YiDuihuanFragment extends Fragment {
	private View v;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		v = inflater.inflate(R.layout.activity_yiduihuan, null);
	...
	public void getMsg(){
		...
		new Thread() {
			public void run() {
				String url = UrlUtils.BASEURL+"v1/busine/my_redeem_code_yes.json";
				String resusult = MyHttpRequest.getHttpPostBasic(url, params,
						token);
				 Log.e("result_ydh", resusult.toString());
				if (resusult != null) {
//					Log.e("result", resusult.toString());
	...
	public class ItemListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = View.inflate(mContext, R.layout.wdh_item,
						null);
				viewHolder = new ViewHolder1();
				viewHolder.image = (ImageView) convertView
						.findViewById(R.id.shangcheng_item_imgv);
				...
				viewHolder.mTv_barname = (TextView) convertView
						.findViewById(R.id.shancheng_barname);
			...
			imageLoader_head.displayImage(entity.getBs_img(), viewHolder.image,
					options_head);
			viewHolder.mTv_barname.setText("消费于:"+entity.getProvince().getS_provname()+entity.getCity().getS_cityname()+entity.getWangba().getW_name());
