package com.jishang.bimeng.activity.yuezhan.wzf;
...
public class WzfddActivity extends BaseActivity {
	private Gson mGson;
	...
	public class ItemListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			viewHolder.mTv_need_persons.setText(entity.getNeed_persons());
			viewHolder.mTv_peple_money.setText(entity.getOne_peple_money());
			viewHolder.mTv_yz_name.setText("测试名字");
			viewHolder.mTv_start_time.setText(times(entity.getP_start_time()));
