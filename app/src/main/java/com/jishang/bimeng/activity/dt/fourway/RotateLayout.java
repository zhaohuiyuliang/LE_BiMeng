...
public class RotateLayout extends LinearLayout {
    ...
    void init() {
        view = LayoutInflater.from(getContext()).inflate(R.layout.rotatelayout, this);
        bm = BitmapFactory.decodeResource(getResources(), R.drawable.userguide_moments_icon);
    ...
    public void reset() {
        ...
        isComplete = true;
        Animation animations = AnimationUtils.loadAnimation(getContext(), R.anim.slide_in_from_top);
