...
public class Fenqian_dataEntity implements Serializable {
    /**
     * 
     */
    private static final long serialVersionUID = -8118569980239916852L;
    ...
    private String money_status;// 0未支付 1已支付

    private Fenqian_data_puEntity promoter_user;

    private Fenqian_data_juEntity join_user;

    public Fenqian_dataEntity() {
        super();
    }

    public Fenqian_dataEntity(String i_pay_or_get, String promoter_uid, String join_peple_uid,
            String yuezhan_id, String pay_get_money, String get_is_pay, String money_status,
            Fenqian_data_puEntity promoter_user, Fenqian_data_juEntity join_user) {
        super();
    ...
    public Fenqian_data_puEntity getPromoter_user() {
        return promoter_user;
    }

    public void setPromoter_user(Fenqian_data_puEntity promoter_user) {
        this.promoter_user = promoter_user;
    }

    public Fenqian_data_juEntity getJoin_user() {
        return join_user;
    }

    public void setJoin_user(Fenqian_data_juEntity join_user) {
        this.join_user = join_user;
    }

    @Override
    public String toString() {
        return "Fenqian_dataEntity [i_pay_or_get=" + i_pay_or_get + ", promoter_uid="
                + promoter_uid + ", join_peple_uid=" + join_peple_uid + ", yuezhan_id="
                + yuezhan_id + ", pay_get_money=" + pay_get_money + ", get_is_pay=" + get_is_pay
                + ", money_status=" + money_status + ", promoter_user=" + promoter_user
                + ", join_user=" + join_user + "]";
    }
