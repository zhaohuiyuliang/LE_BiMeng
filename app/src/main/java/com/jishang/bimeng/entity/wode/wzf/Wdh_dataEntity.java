...
public class Wdh_dataEntity implements Serializable{
	...
	private Wdh_dataBuEntity business;
	...
	public Wdh_dataEntity() {
		super();
	}
	public Wdh_dataEntity(String bp_id, String money, String bus_id,
	...
	public Wdh_dataBuEntity getBusiness() {
		return business;
	}
	public void setBusiness(Wdh_dataBuEntity business) {
		this.business = business;
	}
	@Override
	public String toString() {
		return "Wdh_dataEntity [bp_id=" + bp_id + ", money=" + money
