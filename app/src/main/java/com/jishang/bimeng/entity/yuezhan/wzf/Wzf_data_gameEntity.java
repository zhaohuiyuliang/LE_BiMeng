...
public class Wzf_data_gameEntity implements Serializable{
	...
	private Wzf_data_game_usEntity user;
	...
	public Wzf_data_gameEntity() {
		super();
	}
	public Wzf_data_gameEntity(String yz_id, String yz_title, String yz_img,
			String yz_server, String yz_pattern, String yz_grade,
			String pay_get, String need_persons, String need_peple_item,
			String pay_peple_money, String pay_app_money, String yz_created_at,
			String y_join_status, String y_pay_status, String yzu_id,
			String start_time, String start_time_four, String wait_time,
			String game_continue_time, String yz_remark,
			Wzf_data_game_usEntity user) {
		super();
		this.yz_id = yz_id;
	...
	public Wzf_data_game_usEntity getUser() {
		return user;
	}
	public void setUser(Wzf_data_game_usEntity user) {
		this.user = user;
	}
	@Override
	public String toString() {
		return "Wzf_data_gameEntity [yz_id=" + yz_id + ", yz_title=" + yz_title
				+ ", yz_img=" + yz_img + ", yz_server=" + yz_server
				+ ", yz_pattern=" + yz_pattern + ", yz_grade=" + yz_grade
				+ ", pay_get=" + pay_get + ", need_persons=" + need_persons
				+ ", need_peple_item=" + need_peple_item + ", pay_peple_money="
				+ pay_peple_money + ", pay_app_money=" + pay_app_money
				+ ", yz_created_at=" + yz_created_at + ", y_join_status="
				+ y_join_status + ", y_pay_status=" + y_pay_status
				+ ", yzu_id=" + yzu_id + ", start_time=" + start_time
				+ ", start_time_four=" + start_time_four + ", wait_time="
				+ wait_time + ", game_continue_time=" + game_continue_time
