...
public class Wdh_dataBuEntity implements Serializable{
	...
	private Wdh_dataBu_pvEntity province;
	private Wdh_dataBu_ctEntity city;
	private Wdh_dataBu_wbEntity wangba;
	...
	public Wdh_dataBuEntity() {
		super();
	}
	public Wdh_dataBuEntity(String bs_id, String name, String bs_img,
			...
			String bs_create_time, Wdh_dataBu_pvEntity province,
			Wdh_dataBu_ctEntity city, Wdh_dataBu_wbEntity wangba) {
		super();
		this.bs_id = bs_id;
		this.name = name;
		this.bs_img = bs_img;
	...
	public Wdh_dataBu_pvEntity getProvince() {
		return province;
	}
	public void setProvince(Wdh_dataBu_pvEntity province) {
		this.province = province;
	}
	public Wdh_dataBu_ctEntity getCity() {
		return city;
	}
	public void setCity(Wdh_dataBu_ctEntity city) {
		this.city = city;
	}
	public Wdh_dataBu_wbEntity getWangba() {
		return wangba;
	}
	public void setWangba(Wdh_dataBu_wbEntity wangba) {
		this.wangba = wangba;
	}
	@Override
	public String toString() {
		return "Wdh_dataBuEntity [bs_id=" + bs_id + ", name=" + name
				+ ", bs_img=" + bs_img + ", bg_img=" + bg_img + ", price="
				+ price + ", classification=" + classification
				+ ", bs_province=" + bs_province + ", bs_city=" + bs_city
				+ ", bs_wangba=" + bs_wangba + ", bs_describe=" + bs_describe
