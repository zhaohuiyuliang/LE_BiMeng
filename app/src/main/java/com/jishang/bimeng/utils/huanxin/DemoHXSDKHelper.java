...
public class DemoHXSDKHelper extends HXSDKHelper {
     ...
     * activityList.size() <= 0 鎰忓懗鐫�鎵�鏈夐〉闈㈤兘宸茬粡鍦ㄥ悗鍙拌繍琛岋紝鎴栬�呭凡缁忕寮�Activity
     * Stack
     */
            ...
            public void onEvent(EMNotifierEvent event) {
                ...
                switch (event.getEvent()) {
                    ...
                    case EventNewCMDMessage: {
                        ...
                        EMLog.d(TAG,
                                String.format("閫忎紶娑堟伅锛歛ction:%s,message:%s", action,
                                        message.toString()));
                        final String str = "鏀跺埌閫忎紶锛歛ction锛�";
            ...
            private void showToast(String value) {
                if (!registered) {
                    ...
                    appContext.registerReceiver(new BroadcastReceiver() {
                        ...
                        @Override
                        public void onReceive(Context context, Intent intent) {
                            Toast.makeText(appContext, intent.getStringExtra("value"),
                                    Toast.LENGTH_SHORT).show();
                        }
    ...
    protected HXNotificationInfoProvider getNotificationListener() {
        ...
        return new HXNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                ...
                Intent intent = new Intent(getAppContext(), ActivityChat.class);
                entity.setUsername("闄岀敓浜�");
                entity.setHead_img(new SharUtil(getAppContext()).getHead_img());
